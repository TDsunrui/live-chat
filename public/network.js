...
function rtcStart(roomId, userId) {
  if (!roomId || !userId) {
  ...
  var myConnect = new RTCPeerConnection(configuration, {
  ...
  var websocket = new WebSocket(
    "wss://www.k1aus.cn/webrtc/customerService/" + roomId + "/" + userId + ""
  );
  ...
  function setRemoteSdp(sdp) {
    myConnect.setRemoteDescription(
